...
// Source: internal/customers/repositories/interface.go
...
import (
	...
	entities "github.com/valdirmendesdev/live-doc/internal/customers/entities"
...
func (m *MockCustomer) Create(c *entities.Customer) (*entities.Customer, error) {
	m.ctrl.T.Helper()
...
func (m *MockCustomer) FindById(id types.ID) (*entities.Customer, error) {
	m.ctrl.T.Helper()
...
func (m *MockCustomer) ListAll(limit, page int) ([]entities.Customer, error) {
	m.ctrl.T.Helper()
